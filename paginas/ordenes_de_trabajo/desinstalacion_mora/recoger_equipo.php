...
<html lang="en">
    ...
    <body class="index-page sidebar-collapse">
        ...
        if (isset($_GET['id_cliente'])) {
            ...
            $result_otdesinstalacion = $ot_desinstalacion->buscar_para_actualizar($id_ot_desinstalacion_mora);
...
// --------------- Clic en el boton Guardar ------------------------------------------------------------------
                ...
                $('#btn_recoger_equipo').click(function () {
                    ...
                    cliente_detalle += " por desinstalación por mora";
                    ...
                    $.ajax({
                        ...
                        data: {
                            ...
                            id_ot_desinstalacion_mora: <?php echo $_GET['id_ot_desinstalacion_mora']; ?>,
                            ...
                            setTimeout(function () {
                                ...
                                document.getElementById("btn_recoger_equipo").disabled = false;
                                    ...
                                    setTimeout(function () {
                                        ...
                                        window.location.href = "https://wifinet.ga/paginas/ordenes_de_trabajo/desinstalacion_mora/mostrar_ot_desinstalacion_mora.php";
