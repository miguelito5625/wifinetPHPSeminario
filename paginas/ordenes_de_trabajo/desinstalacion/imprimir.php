...
// set font
    ...
    $pdf->Write(0, 'Detalles OT de desinstalación de servicio ', '', 0, 'L', true, 0, false, false, 0);
...
// create some HTML content
    $html = '<span style="text-align:justify;">'. $id_ot_desinstalacion .'</span>';
...
// create some HTML content
 ...
 <span style="text-align:justify;">'. $fecha_desinstalacion .'</span>';
