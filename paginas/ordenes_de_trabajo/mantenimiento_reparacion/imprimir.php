...
// set font
    ...
    $pdf->Write(0, 'Datos de OT de mantenimiento y reparación ', '', 0, 'L', true, 0, false, false, 0);
...
// create some HTML content
    $html = '<span style="text-align:justify;">'. $id_ot_mantenimiento_reparacion .'</span>';
...
// create some HTML content
 ...
 <span style="text-align:justify;">'. $fecha_man_re .'</span>';
