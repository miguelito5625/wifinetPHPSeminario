...
<html lang="en">
    ...
    <body class="index-page sidebar-collapse">
        ...
        if (isset($_GET['id_ot_man_re'])) {
            ...
            echo '<meta http-equiv="Refresh" content="0;URL=mostrar_ot_mantenimiento_reparacion.php">';
        }
        ?>
                ...
                <div class="container">
                    ...
                    <div id="inputs">
                        <div class="title">
                            ...
                            <h3>Modificar de OT de mantenimiento y reparación</h3>
...
<!--                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-8 col-sm-4 mr-auto">
                                    <input type="hidden" value="<?php echo $id_ot_mantenimiento_reparacion; ?>" name="id_ot_man_re">
                                    ...
                                    <button class="btn btn-primary" name="actualizar_ot_man_re"><i class="material-icons">save</i> Guardar</button>
