...
// set font
    ...
    $pdf->Write(0, 'Detalles OT de cobro a cliente ', '', 0, 'L', true, 0, false, false, 0);
...
// create some HTML content
    $html = '<span style="text-align:justify;">'. $id_ot_cobro_cliente .'</span>';
...
// ------------------------------- Tecnico  ----------------------------------------------------------------
    ...
    $pdf->Write(0, 'Técnico', '', 0, 'L', true, 0, false, false, 0);
...
// create some HTML content
    $html = '<span style="text-align:justify;">'. $nombre_tecnico .'</span>';
...
// create some HTML content
    $html = '<span style="text-align:justify;">'. $descripcion .'</span>';
...
// ------------------------------- Total a Cobrar  ----------------------------------------------------------------
    ...
    $pdf->Write(0, 'Total a Cobrar:', '', 0, 'L', true, 0, false, false, 0);

// create some HTML content
    $html = '<span style="text-align:justify;">Q'.$total_cobrado.'</span>';
