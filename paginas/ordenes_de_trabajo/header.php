...
<link href="../../../estilos/css/dataTables.bootstrap4.min.css" rel="stylesheet" />
<link href="../../../estilos/css/responsive.dataTables.min.css" rel="stylesheet" />
<link href="../../../estilos/css/select.dataTables.min.css" rel="stylesheet" />

<!-- ------------------------ Estilos de las listas ------------------------------ -->
<link href="../../../estilos/css/bootstrap-select.css" rel="stylesheet" />


<!-- ---------------------- Estilos de las notificaciones (iziToast) -------------------------------- -->
...
<!-- Control Center para Material Kit: efect parallax, scripts para control de efectos -->
<script src="../../../estilos/js/material-kit.js?v=2.0.4" type="text/javascript"></script>


<!-- -------------------------- Scripts de las tablas -------------------------- -->
  <script src="../../../estilos/js/jquery.dataTables.min.js" type="text/javascript"></script>
  <script src="../../../estilos/js/dataTables.bootstrap4.min.js" type="text/javascript"></script>
  <script src="../../../estilos/js/dataTables.responsive.min.js" type="text/javascript"></script>
  <script src="../../../estilos/js/dataTables.select.min.js" type="text/javascript"></script>
  
<!-- -------------------------- Scripts de las listas -------------------------- -->
  <script src="../../../estilos/js/plugins/bootstrap-select.js" type="text/javascript"></script>

  
<!-- -------------------------- Scripts de las notificaciones (iziToast) -------------------------- -->
  ...
  <!-- -------------------------- Scripts para fehcas -------------------------- -->
    ...
    <script src="../../../estilos/js/bootstrap-waitingfor.js"></script>
