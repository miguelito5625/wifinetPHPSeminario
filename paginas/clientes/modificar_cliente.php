                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" autocomplete="off" name="fecha_nacimiento" required id="idfecha_nacimiento" class="form-control datetimepicker">
                                ...
                                <div class="col-lg-3 col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" required name="latitud" value="<?php echo $latitud; ?>" class="form-control" id="idlatitud" data-toggle="modal" data-target="#modal_mapa" readonly rel="tooltip" data-placement="bottom" data-original-title="Hacer click para abrir un mapa">
                                ...
                                <div class="col-lg-3 col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" required name="longitud" value="<?php echo $longitud; ?>" class="form-control" id="idlongitud" data-toggle="modal" data-target="#modal_mapa" readonly rel="tooltip" data-placement="bottom" data-original-title="Hacer click para abrir un mapa">
